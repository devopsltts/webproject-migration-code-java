  ...
  implements MBeanServer
{
  ...
  public MBeanServerImpl(String paramString)
  {
    ...
    this.server = localMBeanServerBuilder.newMBeanServer(paramString, null, localMBeanServerDelegate);
  }
  
  public Object instantiate(String paramString)
    throws ReflectionException, MBeanException
  {
    return this.server.instantiate(paramString);
  }
  
  public Object instantiate(String paramString, ObjectName paramObjectName)
    throws ReflectionException, MBeanException, InstanceNotFoundException
  {
    return this.server.instantiate(paramString, paramObjectName);
  }
  
  public Object instantiate(String paramString, Object[] paramArrayOfObject, String[] paramArrayOfString)
    throws ReflectionException, MBeanException
  {
    return this.server.instantiate(paramString, paramArrayOfObject, paramArrayOfString);
  }
  ...
  public Object instantiate(String paramString, ObjectName paramObjectName, Object[] paramArrayOfObject, String[] paramArrayOfString)
    throws ReflectionException, MBeanException, InstanceNotFoundException
  {
    return this.server.instantiate(paramString, paramObjectName, paramArrayOfObject, paramArrayOfString);
  }
  
  public ObjectInstance createMBean(String paramString, ObjectName paramObjectName)
    throws ReflectionException, InstanceAlreadyExistsException, MBeanRegistrationException, MBeanException, NotCompliantMBeanException
  {
    return this.server.createMBean(paramString, paramObjectName);
  }
  ...
  {
    return this.server.createMBean(paramString, paramObjectName1, paramObjectName2);
  }
  ...
  {
    return this.server.invoke(paramObjectName, paramString, paramArrayOfObject, paramArrayOfString);
  }
  ...
  public void addNotificationListener(ObjectName paramObjectName, NotificationListener paramNotificationListener, NotificationFilter paramNotificationFilter, Object paramObject)
    throws InstanceNotFoundException
  {
    this.server.addNotificationListener(paramObjectName, paramNotificationListener, paramNotificationFilter, paramObject);
  }
  ...
  public void addNotificationListener(ObjectName paramObjectName1, ObjectName paramObjectName2, NotificationFilter paramNotificationFilter, Object paramObject)
    throws InstanceNotFoundException
  {
    this.server.addNotificationListener(paramObjectName1, paramObjectName2, paramNotificationFilter, paramObject);
  }
  ...
  {
    this.server.removeNotificationListener(paramObjectName, paramNotificationListener);
  }
  
  public void removeNotificationListener(ObjectName paramObjectName1, ObjectName paramObjectName2)
    throws InstanceNotFoundException, ListenerNotFoundException
  {
    this.server.removeNotificationListener(paramObjectName1, paramObjectName2);
  }
  ...
  public void removeNotificationListener(ObjectName paramObjectName1, ObjectName paramObjectName2, NotificationFilter paramNotificationFilter, Object paramObject)
    throws InstanceNotFoundException, ListenerNotFoundException
  {
    this.server.removeNotificationListener(paramObjectName1, paramObjectName2, paramNotificationFilter, paramObject);
  }
  ...
  public void removeNotificationListener(ObjectName paramObjectName, NotificationListener paramNotificationListener, NotificationFilter paramNotificationFilter, Object paramObject)
    throws InstanceNotFoundException, ListenerNotFoundException
  {
    this.server.removeNotificationListener(paramObjectName, paramNotificationListener, paramNotificationFilter, paramObject);
  }
  
  public MBeanInfo getMBeanInfo(ObjectName paramObjectName)
    throws InstanceNotFoundException, IntrospectionException, ReflectionException
  {
    return this.server.getMBeanInfo(paramObjectName);
  }
  
  public boolean isInstanceOf(ObjectName paramObjectName, String paramString)
    throws InstanceNotFoundException
  {
    return this.server.isInstanceOf(paramObjectName, paramString);
  }
  ...
  {
    return this.server.deserialize(paramObjectName, paramArrayOfByte);
  }
  ...
  {
    return this.server.deserialize(paramString, paramArrayOfByte);
  }
  ...
  {
    return this.server.deserialize(paramString, paramObjectName, paramArrayOfByte);
  }
  
  public ClassLoader getClassLoaderFor(ObjectName paramObjectName)
    throws InstanceNotFoundException
  {
    return this.server.getClassLoaderFor(paramObjectName);
  }
  
  public ClassLoader getClassLoader(ObjectName paramObjectName)
    throws InstanceNotFoundException
  {
    return this.server.getClassLoader(paramObjectName);
  }
