...
public abstract class Cache<K, V>
{
  ...
  public final V get(K paramK)
  {
    ...
    {
      localObject1 = getEntryValue(paramK, i, this.table[index(i, this.table)]);
      if (localObject1 != null) {
        return localObject1;
      }
  ...
  public final void remove(K paramK)
  {
    if (paramK != null) {
      synchronized (this.queue)
      {
        ...
        {
          localCacheEntry = localObject2.next;
  ...
  public final void clear()
  {
    synchronized (this.queue)
    {
      ...
      {
        CacheEntry localCacheEntry;
        for (Object localObject1 = this.table[i]; localObject1 != null; localObject1 = localCacheEntry)
        {
        ...
        do
        {
          if ((localReference instanceof Ref))
          {
            ...
            if (localCacheEntry1 != null)
            {
              ...
              {
                localCacheEntry2 = localObject2.next;
  ...
  private final class CacheEntry<K, V>
  {
    ...
    {
      this.hash = paramK;
      this.key = Cache.this.keyKind.create(this, paramV, Cache.this.queue);
      this.value = Cache.this.valueKind.create(this, paramCache, Cache.this.queue);
      Object localObject;
