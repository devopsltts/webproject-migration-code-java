  ...
  extends XSDAbstractTraverser
{
  ...
  XSSimpleType traverseGlobal(Element paramElement, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar)
  {
    ...
    if (localXSSimpleType != null)
    {
      ...
      if (this.fSchemaHandler.fTolerateDuplicates)
      {
        ...
        this.fSchemaHandler.addGlobalTypeDecl(localXSSimpleType);
      }
    }
  ...
  private XSSimpleType getSimpleType(String paramString, Element paramElement, Object[] paramArrayOfObject, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar)
  {
    ...
    {
      this.fAttrChecker.returnAttrArray(arrayOfObject, paramXSDocumentInfo);
      return errorType(paramString, paramXSDocumentInfo.fTargetNamespace, (short)(j != 0 ? 2 : 16));
    }
    ...
    if (j != 0)
    {
      localXSSimpleType = this.fSchemaHandler.fDVFactory.createTypeRestriction(paramString, paramXSDocumentInfo.fTargetNamespace, (short)i, (XSSimpleType)localObject3, localObject1 == null ? null : new XSObjectListImpl((XSObject[])localObject1, localObject1.length));
    }
    else if (k != 0)
    {
      localXSSimpleType = this.fSchemaHandler.fDVFactory.createTypeList(paramString, paramXSDocumentInfo.fTargetNamespace, (short)i, (XSSimpleType)localObject3, localObject1 == null ? null : new XSObjectListImpl((XSObject[])localObject1, localObject1.length));
    }
    else if (m != 0)
    {
      localObject6 = (XSSimpleType[])((ArrayList)localObject4).toArray(new XSSimpleType[((ArrayList)localObject4).size()]);
      localXSSimpleType = this.fSchemaHandler.fDVFactory.createTypeUnion(paramString, paramXSDocumentInfo.fTargetNamespace, (short)i, (XSSimpleType[])localObject6, localObject1 == null ? null : new XSObjectListImpl((XSObject[])localObject1, localObject1.length));
    }
  ...
  private XSSimpleType errorType(String paramString1, String paramString2, short paramShort)
  {
    ...
    {
    case 2: 
      return this.fSchemaHandler.fDVFactory.createTypeRestriction(paramString1, paramString2, (short)0, localXSSimpleType, null);
    case 16: 
      return this.fSchemaHandler.fDVFactory.createTypeList(paramString1, paramString2, (short)0, localXSSimpleType, null);
    case 8: 
      return this.fSchemaHandler.fDVFactory.createTypeUnion(paramString1, paramString2, (short)0, new XSSimpleType[] { localXSSimpleType }, null);
    }
    return null;
  }
}
