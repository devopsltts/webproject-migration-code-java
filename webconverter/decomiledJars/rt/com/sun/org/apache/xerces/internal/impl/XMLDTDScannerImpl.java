  ...
  implements XMLDTDScanner, XMLComponent, XMLEntityHandler
{
  ...
  {
    this.fLimitAnalyzer = paramXMLLimitAnalyzer;
  }
    ...
    throws IOException
  {
    if (!paramBoolean)
    {
      ...
      if (!this.fEntityScanner.scanData("]", this.fStringBuffer)) {
        this.fEntityScanner.fCurrentEntity.position -= 1;
      }
      return true;
    }
    return false;
    ...
    throws IOException, XNIException
  {
    ...
    while (!this.fEntityScanner.skipChar(62))
    {
      ...
      if ((str4 != null) && ((str4.equals("#REQUIRED")) || (str4.equals("#IMPLIED"))))
      {
        ...
        if (this.nonValidatingMode) {
          this.nvGrammarInfo.attributeDecl(str1, str2, str3, arrayOfString, str4, null, null, null);
        }
      }
      else
      {
        ...
        if (this.nonValidatingMode) {
          this.nvGrammarInfo.attributeDecl(str1, str2, str3, arrayOfString, str4, this.fLiteral, this.fLiteral2, null);
        }
      }
      skipSeparator(false, !scanningInternalSubset());
    }
    ...
    throws IOException, XNIException
  {
    ...
    else
    {
      ...
      scanAttributeValue(paramXMLString1, paramXMLString2, paramString2, this.fAttributes, 0, bool, paramString1);
    }
    return str;
  }
    ...
    throws IOException, XNIException
  {
    ...
    if (str2 != null)
    {
      String str5 = this.fEntityScanner.getBaseSystemId();
      if (str4 != null) {
        this.fEntityStore.addUnparsedEntity(str1, str3, str2, str5, str4);
      } else {
        this.fEntityStore.addExternalEntity(str1, str3, str2, str5);
      }
      if (this.fDTDHandler != null)
      {
        this.fResourceIdentifier.setValues(str3, str2, str5, XMLEntityManager.expandSystemId(str2, str5));
        if (str4 != null) {
    ...
    throws IOException, XNIException
  {
    ...
    if (this.fEntityScanner.scanLiteral(i, this.fString) != i)
    {
      ...
      do
      {
        checkEntityLimit(paramBoolean, paramString, this.fString.length + k);
        k = 0;
        ...
        else
        {
          ...
          k++;
          int m = this.fEntityScanner.peekChar();
          if (XMLChar.isHighSurrogate(m))
          {
            scanSurrogates(this.fStringBuffer2);
          }
          else if (isInvalidLiteral(m))
          {
            reportFatalError("InvalidCharInLiteral", new Object[] { Integer.toHexString(m) });
            this.fEntityScanner.scanChar();
          }
          else if ((m != i) || (j != this.fEntityDepth))
          {
            this.fStringBuffer.append((char)m);
            this.fStringBuffer2.append((char)m);
            this.fEntityScanner.scanChar();
          }
        }
  ...
  private void checkEntityLimit(boolean paramBoolean, String paramString, XMLString paramXMLString)
  {
    checkEntityLimit(paramBoolean, paramString, paramXMLString.length);
  }
  
  private void checkEntityLimit(boolean paramBoolean, String paramString, int paramInt)
  {
    if (this.fLimitAnalyzer == null) {
      this.fLimitAnalyzer = this.fEntityManager.fLimitAnalyzer;
    }
