  ...
  extends DefaultElement
{
  ...
  {
    for (int i = 0; i < this.attrs.length; i++) {
      if ((this.attrs[i].getLocalName().equals(paramString2)) && (nsEquals(this.attrs[i].getNamespaceURI(), paramString1))) {
        return this.attrs[i].getValue();
      }
    }
    return "";
  ...
  {
    for (int i = 0; i < this.attrs.length; i++) {
      if ((this.attrs[i].getName().equals(paramString2)) && (nsEquals(this.attrs[i].getNamespaceURI(), paramString1))) {
        return this.attrs[i];
      }
    }
    return null;
