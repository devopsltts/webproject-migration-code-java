  ...
  extends DTMManager
{
  ...
  {
    this.m_isSecureProcessing = paramBoolean;
  }
  ...
  {
    return this.m_dtmManager.getDTM(paramSource, paramBoolean1, paramDTMWSFilter, paramBoolean2, paramBoolean3);
  }
  
  public DTM getDTM(int paramInt)
  {
    return this.m_dtmManager.getDTM(paramInt);
  }
  
  public int getDTMHandleFromNode(Node paramNode)
  {
    return this.m_dtmManager.getDTMHandleFromNode(paramNode);
  }
  
  public int getDTMIdentity(DTM paramDTM)
  {
    return this.m_dtmManager.getDTMIdentity(paramDTM);
  }
  ...
  {
    if ((this.m_rtfdtm_stack != null) && (this.m_rtfdtm_stack.contains(paramDTM))) {
      return false;
    }
    return this.m_dtmManager.release(paramDTM, paramBoolean);
  }
  
  public DTMIterator createDTMIterator(Object paramObject, int paramInt)
  {
    return this.m_dtmManager.createDTMIterator(paramObject, paramInt);
  }
  
  public DTMIterator createDTMIterator(String paramString, PrefixResolver paramPrefixResolver)
  {
    return this.m_dtmManager.createDTMIterator(paramString, paramPrefixResolver);
  }
  
  public DTMIterator createDTMIterator(int paramInt, DTMFilter paramDTMFilter, boolean paramBoolean)
  {
    return this.m_dtmManager.createDTMIterator(paramInt, paramDTMFilter, paramBoolean);
  }
  ...
  private void init(boolean paramBoolean)
  {
    ...
    this.m_useServicesMechanism = paramBoolean;
  ...
  public void reset()
  {
    ...
    {
      Enumeration localEnumeration = this.m_rtfdtm_stack.elements();
      while (localEnumeration.hasMoreElements()) {
        this.m_dtmManager.release((DTM)localEnumeration.nextElement(), true);
      }
    }
  ...
  {
    this.m_saxLocations.setTop(paramSourceLocator);
  }
  
  public void pushSAXLocator(SourceLocator paramSourceLocator)
  {
    this.m_saxLocations.push(paramSourceLocator);
  }
  ...
  {
    this.m_variableStacks = paramVariableStack;
  }
  ...
  {
    this.m_sourceTreeManager = paramSourceTreeManager;
  }
  ...
  public final ErrorListener getErrorListener()
  {
    ...
    try
    {
      if (null != this.m_ownerGetErrorListener) {
        localErrorListener = (ErrorListener)this.m_ownerGetErrorListener.invoke(this.m_owner, new Object[0]);
      }
    }
    ...
    if (null == localErrorListener)
    {
      ...
      localErrorListener = this.m_defaultErrorListener;
    }
  ...
  {
    this.m_uriResolver = paramURIResolver;
  }
  ...
  {
    this.m_primaryReader = paramXMLReader;
  }
  ...
  {
    this.m_contextNodeLists = paramStack;
  }
  ...
  {
    this.m_contextNodeLists.push(paramDTMIterator);
  }
  ...
  {
    this.m_currentNodes = paramIntStack;
  }
  ...
  {
    this.m_currentNodes.push(paramInt);
  }
  ...
  {
    this.m_predicateRoots.push(paramInt);
  }
  ...
  {
    this.m_iteratorRoots.push(paramInt);
  }
  ...
  {
    this.m_currentExpressionNodes = paramIntStack;
  }
  ...
  {
    this.m_predicatePos.push(paramInt);
  }
  ...
  {
    this.m_currentExpressionNodes.push(paramInt);
  }
  ...
  {
    this.m_prefixResolvers.setTop(paramPrefixResolver);
  }
  ...
  {
    this.m_axesIteratorStack = paramStack;
  }
  
  public final void pushSubContextList(SubContextList paramSubContextList)
  {
    this.m_axesIteratorStack.push(paramSubContextList);
  }
  ...
  public DTM getRTFDTM()
  {
    ...
    if (this.m_rtfdtm_stack == null)
    {
      ...
      localSAX2RTFDTM = (SAX2RTFDTM)this.m_dtmManager.getDTM(null, true, null, false, false);
      this.m_rtfdtm_stack.addElement(localSAX2RTFDTM);
      this.m_which_rtfdtm += 1;
    }
    else if (this.m_which_rtfdtm < 0)
    {
      localSAX2RTFDTM = (SAX2RTFDTM)this.m_rtfdtm_stack.elementAt(++this.m_which_rtfdtm);
    }
    else
    {
      localSAX2RTFDTM = (SAX2RTFDTM)this.m_rtfdtm_stack.elementAt(this.m_which_rtfdtm);
  ...
  public void popRTFContext()
  {
    ...
    {
      if (i >= 0) {
        bool = ((SAX2RTFDTM)this.m_rtfdtm_stack.elementAt(i)).popRewindMark();
      }
    }
    else {
      while (this.m_which_rtfdtm != i)
      {
        bool = ((SAX2RTFDTM)this.m_rtfdtm_stack.elementAt(this.m_which_rtfdtm)).popRewindMark();
        this.m_which_rtfdtm -= 1;
      }
    }
  }
  ...
  public DTMXRTreeFrag getDTMXRTreeFrag(int paramInt)
  {
    ...
    this.m_DTMXRTreeFrags.put(new Integer(paramInt), localDTMXRTreeFrag);
  ...
  private final void releaseDTMXRTreeFrags()
  {
    ...
    Iterator localIterator = this.m_DTMXRTreeFrags.values().iterator();
    ...
    implements ExpressionContext
  {
    ...
    {
      XPathContext.this.m_useServicesMechanism = paramBoolean;
    }
    
    public double toNumber(Node paramNode)
    {
      int i = XPathContext.this.getDTMHandleFromNode(paramNode);
      DTM localDTM = XPathContext.this.getDTM(i);
    ...
    {
      return XPathContext.this.m_variableStacks.getVariableOrParam(XPathContext.this, paramQName);
    }
  }
}
