...
public class FunctionTable
{
  ...
  String getFunctionName(int paramInt)
  {
    ...
    return this.m_functions_customer[(paramInt - 37)].getName();
  }
    ...
    throws TransformerException
  {
    try
    {
      ...
      return (Function)this.m_functions_customer[(paramInt - 37)].newInstance();
    }
  ...
  {
    Object localObject = this.m_functionID_customer.get(paramString);
    if (null == localObject) {
  ...
  public boolean functionAvailable(String paramString)
  {
    ...
    localObject = this.m_functionID_customer.get(paramString);
