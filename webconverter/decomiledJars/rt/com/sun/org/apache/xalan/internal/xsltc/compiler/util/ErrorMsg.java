...
public final class ErrorMsg
{
  ...
  {
    this._code = paramString;
    this._message = paramThrowable.getMessage();
    this._line = 0;
  ...
  public ErrorMsg(String paramString, int paramInt, Object paramObject)
  {
    this._code = paramString;
    this._line = paramInt;
    this._params = new Object[] { paramObject };
  }
  ...
  public ErrorMsg(String paramString, Object paramObject1, Object paramObject2)
  {
    ...
    this._params[0] = paramObject1;
    this._params[1] = paramObject2;
  }
  
  public ErrorMsg(String paramString, SyntaxTreeNode paramSyntaxTreeNode)
  {
    this._code = paramString;
    this._url = getFileName(paramSyntaxTreeNode);
    this._line = paramSyntaxTreeNode.getLineNumber();
  }
  ...
  private String formatLine()
  {
    ...
    if (this._url != null)
    {
      localStringBuffer.append(this._url);
      localStringBuffer.append(": ");
    }
    if (this._line > 0)
    {
      localStringBuffer.append("line ");
      localStringBuffer.append(Integer.toString(this._line));
      localStringBuffer.append(": ");
    }
  ...
  {
    String str = this._params == null ? this._message : null != this._code ? getErrorMessage() : MessageFormat.format(getErrorMessage(), this._params);
  ...
  {
    this._isWarningError = paramBoolean;
  }
