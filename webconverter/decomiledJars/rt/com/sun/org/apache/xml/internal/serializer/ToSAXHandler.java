  ...
  extends SerializerBase
{
    ...
    throws SAXException
  {
    ...
    if (this.m_lexHandler != null)
    {
      ...
      if (this.m_tracer != null) {
        super.fireCommentEvent(this.m_charsBuff, 0, i);
      }
    }
  }
  ...
  {
    this.m_lexHandler = paramLexicalHandler;
  }
  ...
  {
    this.m_shouldGenerateNSAttribute = paramBoolean;
  }
  ...
  {
    this.m_state = paramTransformStateSetter;
  }
