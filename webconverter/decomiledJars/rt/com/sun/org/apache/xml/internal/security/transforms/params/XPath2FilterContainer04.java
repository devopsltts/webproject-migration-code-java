  ...
  implements TransformParam
{
  ...
  {
    return this.constructionElement.getAttributeNS(null, "Filter").equals("intersect");
  }
  
  public boolean isSubtract()
  {
    return this.constructionElement.getAttributeNS(null, "Filter").equals("subtract");
  }
  
  public boolean isUnion()
  {
    return this.constructionElement.getAttributeNS(null, "Filter").equals("union");
  }
  ...
  {
    NodeList localNodeList = this.constructionElement.getChildNodes();
