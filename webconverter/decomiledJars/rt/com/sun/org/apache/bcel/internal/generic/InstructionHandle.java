  ...
  implements Serializable
{
  ...
  {
    Instruction localInstruction = this.instruction;
    this.instruction = paramInstruction;
  ...
  static final InstructionHandle getInstructionHandle(Instruction paramInstruction)
  {
    ...
    ih_list = localInstructionHandle.next;
  ...
  {
    this.targeters.remove(paramInstructionTargeter);
  }
  ...
  {
    return Utility.format(this.i_position, 4, false, ' ') + ": " + this.instruction.toString(paramBoolean);
  }
  ...
  {
    this.instruction.accept(paramVisitor);
  }
}
