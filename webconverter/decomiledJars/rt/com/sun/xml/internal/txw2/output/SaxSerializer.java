  ...
  implements XmlSerializer
{
  ...
  public SaxSerializer(ContentHandler paramContentHandler, LexicalHandler paramLexicalHandler, boolean paramBoolean)
  {
    ...
    else
    {
      ...
      this.writer = localIndentingXMLFilter;
      this.lexical = localIndentingXMLFilter;
    }
  }
  ...
  {
    this.attrs.addAttribute(paramString1, paramString2, getQName(paramString3, paramString2), "CDATA", paramStringBuilder.toString());
  }
