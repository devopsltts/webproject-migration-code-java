  ...
  implements MessageContext
{
  ...
  {
    this.ctxt.setScope(paramString, paramScope);
  }
  
  public MessageContext.Scope getScope(String paramString)
  {
    return this.ctxt.getScope(paramString);
  }
  ...
  {
    return this.ctxt.containsKey(paramObject);
  }
  
  public boolean containsValue(Object paramObject)
  {
    return this.ctxt.containsValue(paramObject);
  }
  ...
  {
    return this.ctxt.get(paramObject);
  }
  ...
  {
    return this.ctxt.put(paramString, paramObject);
  }
  
  public void putAll(Map<? extends String, ? extends Object> paramMap)
  {
    this.ctxt.putAll(paramMap);
  }
  
  public Object remove(Object paramObject)
  {
    return this.ctxt.remove(paramObject);
  }
