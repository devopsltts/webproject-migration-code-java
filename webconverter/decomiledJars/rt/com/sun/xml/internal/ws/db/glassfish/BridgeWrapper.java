  ...
  implements XMLBridge<T>
{
  ...
  {
    return this.bridge.equals(paramObject);
  }
  ...
  {
    this.bridge.marshal(paramMarshaller, paramT, paramContentHandler);
  }
  
  public void marshal(Marshaller paramMarshaller, T paramT, Node paramNode)
    throws JAXBException
  {
    this.bridge.marshal(paramMarshaller, paramT, paramNode);
  }
    ...
    throws DatabindingException
  {
    try
    {
      return this.bridge.unmarshal(paramSource);
    }
