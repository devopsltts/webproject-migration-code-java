  ...
  implements SOAPBinding
{
  ...
  {
    this.portKnownHeaders = paramSet;
  }
  
  public boolean understandsHeader(QName paramQName)
  {
    return (this.serviceMode == Service.Mode.MESSAGE) || (this.portKnownHeaders.contains(paramQName)) || (this.bindingUnderstoodHeaders.contains(paramQName));
  }
  ...
  {
    paramSet.addAll(this.soapVersion.requiredRoles);
  }
  ...
  {
    this.features.setMTOMEnabled(paramBoolean);
  }
