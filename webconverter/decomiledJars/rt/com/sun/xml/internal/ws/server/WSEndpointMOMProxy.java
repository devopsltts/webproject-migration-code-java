  ...
  implements ManagedObjectManager
{
  ...
  {
    this.wsEndpoint = paramWSEndpointImpl;
  }
  ...
  {
    this.managedObjectManager = paramManagedObjectManager;
  }
  ...
  public boolean equalsProxiedInstance(WSEndpoint paramWSEndpoint)
  {
    ...
    return this.wsEndpoint.equals(paramWSEndpoint);
  }
  ...
  {
    this.wsEndpoint.setExecutor(paramExecutor);
  }
  ...
  {
    this.wsEndpoint.schedule(paramPacket, paramCompletionCallback, paramFiberContextSwitchInterceptor);
  }
  ...
  {
    return this.wsEndpoint.getEndpointReference(paramClass, paramString1, paramString2, paramVarArgs);
  }
  ...
  {
    return this.wsEndpoint.getEndpointReference(paramClass, paramString1, paramString2, paramList1, paramList2);
  }
  ...
  {
    return this.wsEndpoint.createServiceResponseForException(paramThrowableContainerPropertySet, paramPacket, paramSOAPVersion, paramWSDLPort, paramSEIModel, paramWSBinding);
  }
}
