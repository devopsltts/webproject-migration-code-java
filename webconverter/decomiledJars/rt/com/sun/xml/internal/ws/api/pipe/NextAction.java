...
public final class NextAction
{
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("next=").append(this.next).append(',');
    localStringBuilder.append("packet=").append(this.packet != null ? this.packet.toShortString() : null).append(',');
    localStringBuilder.append("throwable=").append(this.throwable).append(']');
