  ...
  implements Attributes
{
  ...
  {
    return (paramInt >= 0) && (paramInt < this._attributeCount) ? this._strings[((paramInt << 3) + 0)] : null;
  }
  
  public final String getLocalName(int paramInt)
  {
    return (paramInt >= 0) && (paramInt < this._attributeCount) ? this._strings[((paramInt << 3) + 2)] : null;
  }
  
  public final String getQName(int paramInt)
  {
    return (paramInt >= 0) && (paramInt < this._attributeCount) ? this._strings[((paramInt << 3) + 3)] : null;
  }
  
  public final String getType(int paramInt)
  {
    return (paramInt >= 0) && (paramInt < this._attributeCount) ? this._strings[((paramInt << 3) + 4)] : null;
  }
  
  public final String getURI(int paramInt)
  {
    return (paramInt >= 0) && (paramInt < this._attributeCount) ? this._strings[((paramInt << 3) + 1)] : null;
  }
  
  public final String getValue(int paramInt)
  {
    return (paramInt >= 0) && (paramInt < this._attributeCount) ? this._strings[((paramInt << 3) + 5)] : null;
  }
  
  public final int getIndex(String paramString)
  {
    for (int i = 0; i < this._attributeCount; i++) {
      if (paramString.equals(this._strings[((i << 3) + 3)])) {
        return i;
      }
    }
    return -1;
  ...
  {
    for (int i = 0; i < this._attributeCount; i++) {
      if ((paramString2.equals(this._strings[((i << 3) + 2)])) && (paramString1.equals(this._strings[((i << 3) + 1)]))) {
        return i;
      }
    }
    return -1;
