  ...
  implements TypeCodeReader
{
  ...
  public TypeCodeImpl getTypeCodeAtPosition(int paramInt)
  {
    ...
    return (TypeCodeImpl)this.typeMap.get(new Integer(paramInt));
  }
  ...
  public void printTypeMap()
  {
    ...
    ArrayList localArrayList = new ArrayList(this.typeMap.keySet());
    Collections.sort(localArrayList);
    Iterator localIterator = localArrayList.iterator();
    while (localIterator.hasNext())
    {
      Integer localInteger = (Integer)localIterator.next();
      TypeCodeImpl localTypeCodeImpl = (TypeCodeImpl)this.typeMap.get(localInteger);
