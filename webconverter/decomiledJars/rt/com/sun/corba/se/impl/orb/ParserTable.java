    ...
    Operation local4 = new Operation()
    {
      public Object operate(Object paramAnonymousObject)
      {
        ...
        try
        {
          ...
          throw ParserTable.this.wrapper.illegalSocketFactoryType(localClass.toString());
        }
        catch (Exception localException)
        {
          throw ParserTable.this.wrapper.badCustomSocketFactory(localException, str);
        }
      }
    };
    return local4;
    ...
    Operation local6 = new Operation()
    {
      public Object operate(Object paramAnonymousObject)
      {
        ...
        try
        {
          ...
          throw ParserTable.this.wrapper.illegalIorToSocketInfoType(localClass.toString());
        }
        catch (Exception localException)
        {
          throw ParserTable.this.wrapper.badCustomIorToSocketInfo(localException, str);
        }
      }
    };
    return local6;
    ...
    Operation local7 = new Operation()
    {
      public Object operate(Object paramAnonymousObject)
      {
        ...
        try
        {
          ...
          throw ParserTable.this.wrapper.illegalIiopPrimaryToContactInfoType(localClass.toString());
        }
        catch (Exception localException)
        {
          throw ParserTable.this.wrapper.badCustomIiopPrimaryToContactInfo(localException, str);
        }
      }
    };
    return local7;
    ...
    Operation local8 = new Operation()
    {
      public Object operate(Object paramAnonymousObject)
      {
        ...
        try
        {
          ...
          throw ParserTable.this.wrapper.illegalContactInfoListFactoryType(localClass.toString());
        }
        catch (Exception localException)
        {
          throw ParserTable.this.wrapper.badContactInfoListFactory(localException, str);
        }
      }
    };
    return local8;
    ...
    Operation local13 = new Operation()
    {
      public Object operate(Object paramAnonymousObject)
      {
        ...
        if (ORBInitializer.class.isAssignableFrom(localClass))
        {
          ...
          {
            throw ParserTable.this.wrapper.orbInitializerFailure(localPrivilegedActionException.getException(), localClass.getName());
          }
          catch (Exception localException)
          {
            throw ParserTable.this.wrapper.orbInitializerFailure(localException, localClass.getName());
          }
          return localORBInitializer;
        }
        throw ParserTable.this.wrapper.orbInitializerType(localClass.getName());
      }
    };
    ...
    Operation local14 = new Operation()
    {
      public Object operate(Object paramAnonymousObject)
      {
        ...
        if (Acceptor.class.isAssignableFrom(localClass))
        {
          ...
          {
            throw ParserTable.this.wrapper.acceptorInstantiationFailure(localPrivilegedActionException.getException(), localClass.getName());
          }
          catch (Exception localException)
          {
            throw ParserTable.this.wrapper.acceptorInstantiationFailure(localException, localClass.getName());
          }
          return localAcceptor;
        }
        throw ParserTable.this.wrapper.acceptorInstantiationTypeFailure(localClass.getName());
      }
    };
