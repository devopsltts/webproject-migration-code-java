...
public class SSLContext
{
    ...
    throws NoSuchAlgorithmException, NoSuchProviderException
  {
    ...
    return new SSLContext((SSLContextSpi)localInstance.impl, localInstance.provider, paramString1);
  }
  ...
  {
    this.contextSpi.engineInit(paramArrayOfKeyManager, paramArrayOfTrustManager, paramSecureRandom);
  }
