  ...
  implements Name
{
  ...
  {
    this.impl = new NameImpl(null, paramEnumeration);
  }
  
  public CompositeName(String paramString)
    throws InvalidNameException
  {
    this.impl = new NameImpl(null, paramString);
  }
  ...
  {
    return (paramObject != null) && ((paramObject instanceof CompositeName)) && (this.impl.equals(((CompositeName)paramObject).impl));
  }
