  ...
  implements SwingConstants, Accessible
{
  ...
  public void setIcon(Icon paramIcon)
  {
    ...
    if ((this.accessibleContext != null) && (localIcon != this.defaultIcon)) {
      this.accessibleContext.firePropertyChange("AccessibleVisibleData", localIcon, this.defaultIcon);
    }
    if (this.defaultIcon != localIcon)
    {
      if ((this.defaultIcon == null) || (localIcon == null) || (this.defaultIcon.getIconWidth() != localIcon.getIconWidth()) || (this.defaultIcon.getIconHeight() != localIcon.getIconHeight())) {
        revalidate();
      }
      repaint();
    }
  ...
  {
    if ((!isShowing()) || ((!SwingUtilities.doesIconReferenceImage(getIcon(), paramImage)) && (!SwingUtilities.doesIconReferenceImage(this.disabledIcon, paramImage)))) {
      return false;
    }
