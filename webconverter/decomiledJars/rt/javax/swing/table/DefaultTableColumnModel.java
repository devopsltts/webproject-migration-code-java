  ...
  implements TableColumnModel, PropertyChangeListener, ListSelectionListener, Serializable
{
  ...
  public void moveColumn(int paramInt1, int paramInt2)
  {
    ...
    TableColumn localTableColumn = (TableColumn)this.tableColumns.elementAt(paramInt1);
    ...
    this.tableColumns.insertElementAt(localTableColumn, paramInt2);
  ...
  {
    this.columnSelectionAllowed = paramBoolean;
  }
  ...
  public int[] getSelectedColumns()
  {
    if (this.selectionModel != null)
    {
      ...
      int k = 0;
      for (int m = i; m <= j; m++) {
        if (this.selectionModel.isSelectedIndex(m)) {
          arrayOfInt1[(k++)] = m;
        }
      }
  ...
  {
    this.listenerList.add(TableColumnModelListener.class, paramTableColumnModelListener);
  }
  
  public void removeColumnModelListener(TableColumnModelListener paramTableColumnModelListener)
  {
    this.listenerList.remove(TableColumnModelListener.class, paramTableColumnModelListener);
  }
  ...
  {
    Enumeration localEnumeration = getColumns();
    for (this.totalColumnWidth = 0; localEnumeration.hasMoreElements(); this.totalColumnWidth += ((TableColumn)localEnumeration.nextElement()).getWidth()) {}
  }
