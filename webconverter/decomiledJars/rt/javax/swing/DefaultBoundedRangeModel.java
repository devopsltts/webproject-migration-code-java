  ...
  implements BoundedRangeModel, Serializable
{
  ...
  {
    setRangeProperties(this.value, this.extent, this.min, this.max, paramBoolean);
  }
  ...
  public void setRangeProperties(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    int i = (paramInt1 != this.value) || (paramInt2 != this.extent) || (paramInt3 != this.min) || (paramInt4 != this.max) || (paramBoolean != this.isAdjusting) ? 1 : 0;
    if (i != 0)
    {
      this.value = paramInt1;
      this.extent = paramInt2;
