  ...
  extends AbstractBorder
{
  ...
  {
    return this.highlight != null ? this.highlight : paramComponent.getBackground().brighter();
  }
  ...
  {
    return this.shadow != null ? this.shadow : paramComponent.getBackground().darker();
  }
