  ...
  extends OptionPaneUI
{
  ...
  public void selectInitialValue(JOptionPane paramJOptionPane)
  {
    for (int i = 0; i < this.uis.size(); i++) {
      ((OptionPaneUI)this.uis.elementAt(i)).selectInitialValue(paramJOptionPane);
    }
  }
  
  public boolean containsCustomComponents(JOptionPane paramJOptionPane)
  {
    boolean bool = ((OptionPaneUI)this.uis.elementAt(0)).containsCustomComponents(paramJOptionPane);
    for (int i = 1; i < this.uis.size(); i++) {
      ((OptionPaneUI)this.uis.elementAt(i)).containsCustomComponents(paramJOptionPane);
    }
    return bool;
  }
  ...
  public static ComponentUI createUI(JComponent paramJComponent)
  {
    ...
    return MultiLookAndFeel.createUIs(localMultiOptionPaneUI, ((MultiOptionPaneUI)localMultiOptionPaneUI).uis, paramJComponent);
  }
