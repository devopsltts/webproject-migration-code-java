  ...
  extends MenuItemLayoutHelper
{
  ...
  {
    return this.style.getBoolean(this.context, paramString + ".alignAcceleratorText", true);
  }
  ...
  protected void calcWidthsAndHeights()
  {
    ...
    else
    {
      ...
      this.gu.layoutText(this.context, getFontMetrics(), getText(), getIcon(), getHorizontalAlignment(), getVerticalAlignment(), getHorizontalTextPosition(), getVerticalTextPosition(), getViewRect(), localRectangle2, localRectangle1, getGap());
      localRectangle1.width += getLeftTextExtraWidth();
      Rectangle localRectangle3 = localRectangle2.union(localRectangle1);
      getLabelSize().setHeight(localRectangle3.height);
      getLabelSize().setWidth(localRectangle3.width);
    }
  }
