...
import java.rmi.MarshalledObjec;
...
import javax.security.auth.Subjec;
    ...
    throws SystemException
  {
    try
    {
      ...
      case 'A': 
        ...
        {
          localObject1 = (ObjectName)localInputStream.read_value(ObjectName.class);
          localObject2 = (String[])localInputStream.read_value(new Strin[0].getClass());
          localObject4 = (Subject)localInputStream.read_value(Subject.class);
          try
          {
      ...
      case 'D': 
        ...
        if (paramString.equals("getDomains"))
        {
          ...
          localOutputStream3.write_value(cast_array(localObject3), new Strin[0].getClass());
      ...
      case 'N': 
        ...
        {
          localObject1 = (ObjectName[])localInputStream.read_value(new ObjectNam[0].getClass());
          localObject3 = (MarshalledObject[])localInputStream.read_value(new MarshalledObjec[0].getClass());
          localObject5 = (Subject[])localInputStream.read_value(new Subjec[0].getClass());
          try
          {
          ...
          ((org.omg.CORBA_2_3.portable.OutputStream)localObject15).write_value(cast_array(localObject9), new Intege[0].getClass());
      ...
      case 'a': 
        ...
        if (paramString.equals("createMBean__CORBA_WStringValue__javax_management_ObjectName__java_rmi_MarshalledObject__org_omg_boxedRMI_CORBA_seq1_WStringValue__javax_security_auth_Subject"))
        {
          ...
          localObject3 = (ObjectName)localInputStream.read_value(ObjectName.class);
          localObject5 = (MarshalledObject)localInputStream.read_value(MarshalledObject.class);
          localObject10 = (String[])localInputStream.read_value(new Strin[0].getClass());
        ...
        if (paramString.equals("createMBean__CORBA_WStringValue__javax_management_ObjectName__javax_management_ObjectName__java_rmi_MarshalledObject__org_omg_boxedRMI_CORBA_seq1_WStringValue__javax_security_auth_Subject"))
        {
          ...
          localObject16 = (String[])localInputStream.read_value(new Strin[0].getClass());
      ...
      case 'o': 
        if (paramString.equals("invoke"))
        {
          ...
          String[] arrayOfString = (String[])localInputStream.read_value(new Strin[0].getClass());
        ...
        {
          localObjectName = (ObjectName)localInputStream.read_value(ObjectName.class);
          localObject3 = (Integer[])localInputStream.read_value(new Intege[0].getClass());
          localObject6 = (Subject)localInputStream.read_value(Subject.class);
          try
          {
