  ...
  implements MemoryPoolMXBean
{
    ...
    extends Sensor
  {
    ...
    {
      super();
      this.pool = paramMemoryPoolImpl;
    }
    
    void triggerAction(MemoryUsage paramMemoryUsage)
    {
      MemoryImpl.createNotification("java.management.memory.collection.threshold.exceeded", this.pool.getName(), paramMemoryUsage, MemoryPoolImpl.this.gcSensor.getCount());
    }
