  ...
  extends PathGraphics
{
    ...
    throws PrinterException
  {
    ...
    localPSPrinterJob.drawImageBGR(localByteComponentRaster.getDataStorage(), localFloat.x, localFloat.y, localFloat.width, localFloat.height, 0.0F, 0.0F, localBufferedImage.getWidth(), localBufferedImage.getHeight(), localBufferedImage.getWidth(), localBufferedImage.getHeight());
  }
