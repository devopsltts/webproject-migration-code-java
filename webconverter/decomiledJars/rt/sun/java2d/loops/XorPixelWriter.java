  ...
  extends PixelWriter
{
    ...
    extends XorPixelWriter
  {
    ...
    {
      this.xorData = ((byte[])paramObject1);
      xorPixel(paramObject2);
      this.xorData = ((byte[])paramObject2);
    }
    ...
    extends XorPixelWriter
  {
    ...
    {
      this.xorData = ((int[])paramObject1);
      xorPixel(paramObject2);
      this.xorData = ((int[])paramObject2);
    }
    ...
    extends XorPixelWriter
  {
    ...
    {
      this.xorData = ((short[])paramObject1);
      xorPixel(paramObject2);
      this.xorData = ((short[])paramObject2);
    }
