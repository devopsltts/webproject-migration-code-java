  ...
  implements DerEncoder
{
    ...
    throws IllegalArgumentException
  {
    ...
    Class localClass = this.index == -1 ? BYTE_ARRAY_CLASS : VALUE_CLASSES[this.index];
    ...
    throws IOException
  {
    ...
    {
    case -1: 
      localDerOutputStream.write((byte[])this.value);
      break;
    case 1: 
    case 2: 
      localObject1 = (String[])this.value;
    ...
    case 4: 
      localObject1 = new DerOutputStream();
      ((DerOutputStream)localObject1).putOctetString((byte[])this.value);
      localDerOutputStream.write((byte)49, ((DerOutputStream)localObject1).toByteArray());
      break;
    case 5: 
      localObject1 = new DerOutputStream();
      ...
      break;
    case 6: 
      localDerOutputStream.putOrderedSetOf((byte)49, (DerEncoder[])this.value);
      break;
    case 7: 
      localObject1 = new DerOutputStream();
    ...
    case 17: 
      localDerOutputStream.write((byte)49, (byte[])this.value);
      break;
    }
  ...
  {
    return (this.index == -1) || (SINGLE_VALUED[this.index] != 0);
  }
  ...
  public String toString()
  {
    ...
    if (this.index == -1) {
      localStringBuffer.append(this.oid.toString());
    } else {
      localStringBuffer.append((String)OID_NAME_TABLE.get(PKCS9_OIDS[this.index]));
    }
    localStringBuffer.append(": ");
    if ((this.index == -1) || (SINGLE_VALUED[this.index] != 0))
    {
      if ((this.value instanceof byte[]))
      {
        HexDumpEncoder localHexDumpEncoder = new HexDumpEncoder();
        localStringBuffer.append(localHexDumpEncoder.encodeBuffer((byte[])this.value));
      }
      else
      {
