  ...
  implements NavigableSet<E>, Cloneable, Serializable
{
  ...
  public boolean addAll(Collection<? extends E> paramCollection)
  {
    if ((this.m.size() == 0) && (paramCollection.size() > 0) && ((paramCollection instanceof SortedSet)) && ((this.m instanceof TreeMap)))
    {
      ...
      TreeMap localTreeMap = (TreeMap)this.m;
  ...
  public E pollFirst()
  {
    Map.Entry localEntry = this.m.pollFirstEntry();
    return localEntry == null ? null : localEntry.getKey();
  }
  
  public E pollLast()
  {
    Map.Entry localEntry = this.m.pollLastEntry();
    return localEntry == null ? null : localEntry.getKey();
  }
  ...
  public Object clone()
  {
    ...
    localTreeSet.m = new TreeMap(this.m);
    return localTreeSet;
  }
