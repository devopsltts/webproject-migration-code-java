...
public class AlgorithmParameterGenerator
{
  ...
  {
    this.paramGenSpi.engineInit(paramInt, new SecureRandom());
  }
  
  public final void init(int paramInt, SecureRandom paramSecureRandom)
  {
    this.paramGenSpi.engineInit(paramInt, paramSecureRandom);
  }
  
  public final void init(AlgorithmParameterSpec paramAlgorithmParameterSpec)
    throws InvalidAlgorithmParameterException
  {
    this.paramGenSpi.engineInit(paramAlgorithmParameterSpec, new SecureRandom());
  }
  
  public final void init(AlgorithmParameterSpec paramAlgorithmParameterSpec, SecureRandom paramSecureRandom)
    throws InvalidAlgorithmParameterException
  {
    this.paramGenSpi.engineInit(paramAlgorithmParameterSpec, paramSecureRandom);
  }
