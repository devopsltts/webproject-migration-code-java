  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return (this.color == localPageAttributes.color) && (this.media == localPageAttributes.media) && (this.orientationRequested == localPageAttributes.orientationRequested) && (this.origin == localPageAttributes.origin) && (this.printQuality == localPageAttributes.printQuality) && (this.printerResolution[0] == localPageAttributes.printerResolution[0]) && (this.printerResolution[1] == localPageAttributes.printerResolution[1]) && (this.printerResolution[2] == localPageAttributes.printerResolution[2]);
  }
  ...
  {
    return "color=" + getColor() + ",media=" + getMedia() + ",orientation-requested=" + getOrientationRequested() + ",origin=" + getOrigin() + ",print-quality=" + getPrintQuality() + ",printer-resolution=[" + this.printerResolution[0] + "," + this.printerResolution[1] + "," + this.printerResolution[2] + "]";
  }
