...
public final class LineBreakMeasurer
{
  ...
  {
    return nextOffset(paramFloat, this.limit, false);
  }
  ...
  {
    return nextLayout(paramFloat, this.limit, false);
  }
  ...
  public TextLayout nextLayout(float paramFloat, int paramInt, boolean paramBoolean)
  {
    if (this.pos < this.limit)
    {
      ...
      TextLayout localTextLayout = this.measurer.getLayout(this.pos, i);
      this.pos = i;
