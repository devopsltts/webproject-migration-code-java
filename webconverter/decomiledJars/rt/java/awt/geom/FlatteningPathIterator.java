  ...
  private void next(boolean paramBoolean)
  {
    ...
    case 2: 
      if (this.holdIndex >= this.holdEnd)
      {
        ...
        double tmp308_307 = this.hold[2];
        this.curx = tmp308_307;
        this.hold[(this.holdIndex + 4)] = tmp308_307;
        double tmp330_329 = this.hold[3];
        this.cury = tmp330_329;
        this.hold[(this.holdIndex + 5)] = tmp330_329;
      }
      i = this.levels[this.levelIndex];
      while ((i < this.limit) && (QuadCurve2D.getFlatnessSq(this.hold, this.holdIndex) >= this.squareflat))
      {
    ...
    case 3: 
      if (this.holdIndex >= this.holdEnd)
      {
        ...
        double tmp628_627 = this.hold[4];
        this.curx = tmp628_627;
        this.hold[(this.holdIndex + 6)] = tmp628_627;
        double tmp651_650 = this.hold[5];
        this.cury = tmp651_650;
        this.hold[(this.holdIndex + 7)] = tmp651_650;
      }
      i = this.levels[this.levelIndex];
      while ((i < this.limit) && (CubicCurve2D.getFlatnessSq(this.hold, this.holdIndex) >= this.squareflat))
      {
