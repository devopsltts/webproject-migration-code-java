  ...
  implements PathIterator
{
  ...
  public int currentSegment(float[] paramArrayOfFloat)
  {
    ...
    if (this.index == 0)
    {
      ...
      paramArrayOfFloat[0] = ((float)(this.x + arrayOfDouble[4] * this.w));
      paramArrayOfFloat[1] = ((float)(this.y + arrayOfDouble[5] * this.h));
      if (this.affine != null) {
  ...
  public int currentSegment(double[] paramArrayOfDouble)
  {
    ...
    {
      arrayOfDouble = ctrlpts[3];
      paramArrayOfDouble[0] = (this.x + arrayOfDouble[4] * this.w);
      paramArrayOfDouble[1] = (this.y + arrayOfDouble[5] * this.h);
      if (this.affine != null) {
