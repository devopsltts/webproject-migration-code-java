  ...
  implements Shape, Cloneable
{
    ...
    implements Serializable
  {
    ...
    public void setCurve(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8)
    {
      ...
      this.ctrlx1 = paramDouble3;
      this.ctrly1 = paramDouble4;
      this.ctrlx2 = paramDouble5;
      this.ctrly2 = paramDouble6;
      this.x2 = paramDouble7;
      this.y2 = paramDouble8;
    }
    ...
    implements Serializable
  {
    ...
    public void setCurve(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8)
    {
      ...
      this.ctrlx1 = ((float)paramDouble3);
      this.ctrly1 = ((float)paramDouble4);
      this.ctrlx2 = ((float)paramDouble5);
      this.ctrly2 = ((float)paramDouble6);
      this.x2 = ((float)paramDouble7);
      this.y2 = ((float)paramDouble8);
    }
    ...
    public void setCurve(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8)
    {
      this.x1 = paramFloat1;
      this.y1 = paramFloat2;
      this.ctrlx1 = paramFloat3;
      this.ctrly1 = paramFloat4;
      this.ctrlx2 = paramFloat5;
      this.ctrly2 = paramFloat6;
      this.x2 = paramFloat7;
      this.y2 = paramFloat8;
    }
