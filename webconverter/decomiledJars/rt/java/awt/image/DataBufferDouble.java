  ...
  extends DataBuffer
{
  ...
  public DataBufferDouble(int paramInt1, int paramInt2)
  {
    ...
    for (int i = 0; i < paramInt2; i++) {
      this.bankdata[i] = new double[paramInt1];
    }
  ...
  {
    return (int)this.data[(paramInt + this.offset)];
  }
  
  public int getElem(int paramInt1, int paramInt2)
  {
    return (int)this.bankdata[paramInt1][(paramInt2 + this.offsets[paramInt1])];
  }
  ...
  {
    return (float)this.data[(paramInt + this.offset)];
  }
  
  public float getElemFloat(int paramInt1, int paramInt2)
  {
    return (float)this.bankdata[paramInt1][(paramInt2 + this.offsets[paramInt1])];
  }
