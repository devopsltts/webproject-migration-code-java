  ...
  extends SocketImpl
{
    ...
    throws UnknownHostException, IOException
  {
    ...
    try
    {
      ...
      connectToAddress(localInetAddress, paramInt, this.timeout);
      i = 1;
      return;
    }
    finally
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      this.address = localInetSocketAddress.getAddress();
    ...
    throws SocketException
  {
    ...
    case 15: 
      ...
      return localInetAddressContainer.addr;
    case 4097: 
    case 4098: 
      i = socketGetOption(paramInt, null);
  ...
  {
    this.socketInputStream = paramSocketInputStream;
  }
