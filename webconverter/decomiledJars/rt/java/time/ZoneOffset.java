  ...
  implements TemporalAccessor, TemporalAdjuster, Comparable<ZoneOffset>, Serializable
{
  ...
  public <R> R query(TemporalQuery<R> paramTemporalQuery)
  {
    ...
    return super.query(paramTemporalQuery);
  }
  
  public Temporal adjustInto(Temporal paramTemporal)
  {
    return paramTemporal.with(ChronoField.OFFSET_SECONDS, this.totalSeconds);
  }
  
  public int compareTo(ZoneOffset paramZoneOffset)
  {
    return paramZoneOffset.totalSeconds - this.totalSeconds;
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof ZoneOffset)) {
      return this.totalSeconds == ((ZoneOffset)paramObject).totalSeconds;
    }
    return false;
  }
