  ...
  extends CharBuffer
{
  ...
  {
    return this.hb[ix(checkIndex(paramInt))];
  }
  
  char getUnchecked(int paramInt)
  {
    return this.hb[ix(paramInt)];
  }
  ...
  public CharBuffer put(CharBuffer paramCharBuffer)
  {
    if ((paramCharBuffer instanceof HeapCharBuffer))
    {
      ...
      System.arraycopy(localHeapCharBuffer.hb, localHeapCharBuffer.ix(localHeapCharBuffer.position()), this.hb, ix(position()), j);
