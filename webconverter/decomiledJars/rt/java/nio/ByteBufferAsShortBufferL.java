  ...
  extends ShortBuffer
{
  ...
  {
    return new ByteBufferAsShortBufferL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
  }
  
  public ShortBuffer asReadOnlyBuffer()
  {
    return new ByteBufferAsShortBufferRL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
  }
