  ...
  implements XMLStreamWriter
{
    ...
    throws XMLStreamException
  {
    ...
    this._writer = new XMLWriter(paramOutputStream, paramString, localCharset);
  }
  ...
  public void writeStartDocument(String paramString)
    throws XMLStreamException
  {
    writeStartDocument(this._encoding, paramString, null);
  }
    ...
    throws XMLStreamException
  {
    ...
    for (int k = 0; k < j; k++)
    {
      ...
      if (!this._writer.canEncode(c))
      {
        this._writer.write(paramString, i, k - i);
        this._writer.write("&#x");
        this._writer.write(Integer.toHexString(c));
        this._writer.write(59);
        i = k + 1;
  ...
  protected class Element
  {
    ...
    {
      this._parent = paramElement;
      this._localpart = paramString;
      this._isEmptyElement = paramBoolean;
    }
