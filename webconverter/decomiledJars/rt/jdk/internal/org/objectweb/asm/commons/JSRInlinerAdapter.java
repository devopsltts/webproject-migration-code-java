  ...
  implements Opcodes
{
  ...
  private void emitCode()
  {
    ...
    localLinkedList.add(new Instantiation(null, this.mainSubroutine));
  ...
  private void emitSubroutine(Instantiation paramInstantiation, List<Instantiation> paramList, InsnList paramInsnList, List<TryCatchBlockNode> paramList1, List<LocalVariableNode> paramList2)
  {
    ...
    while (i < j)
    {
      ...
      else if (localObject4 == paramInstantiation)
      {
        if (((AbstractInsnNode)localObject3).getOpcode() == 169)
        {
          ...
          for (localObject5 = paramInstantiation; localObject5 != null; localObject5 = ((Instantiation)localObject5).previous) {
            if (((Instantiation)localObject5).subroutine.get(i)) {
              localLabelNode1 = ((Instantiation)localObject5).returnLabel;
            }
          }
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localObject3 != localObject4)
      {
        ...
        paramList1.add(new TryCatchBlockNode((LabelNode)localObject3, (LabelNode)localObject4, localLabelNode1, ((TryCatchBlockNode)localObject2).type));
      }
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localObject3 != localObject4) {
        paramList2.add(new LocalVariableNode(((LocalVariableNode)localObject2).name, ((LocalVariableNode)localObject2).desc, ((LocalVariableNode)localObject2).signature, (LabelNode)localObject3, (LabelNode)localObject4, ((LocalVariableNode)localObject2).index));
      }
    }
  }
    ...
    extends AbstractMap<LabelNode, LabelNode>
  {
    ...
    Instantiation(Instantiation paramInstantiation, BitSet paramBitSet)
    {
      ...
      localObject = null;
      int i = 0;
      int j = JSRInlinerAdapter.this.instructions.size();
      while (i < j)
      {
        AbstractInsnNode localAbstractInsnNode = JSRInlinerAdapter.this.instructions.get(i);
    ...
    public Instantiation findOwner(int paramInt)
    {
      ...
      if (!JSRInlinerAdapter.this.dualCitizens.get(paramInt)) {
        return this;
      }
    ...
    {
      Instantiation localInstantiation = findOwner(JSRInlinerAdapter.this.instructions.indexOf(paramLabelNode));
