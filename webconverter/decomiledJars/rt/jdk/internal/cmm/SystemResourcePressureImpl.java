  ...
  implements SystemResourcePressureMXBean
{
  ...
  public void setMemoryPressure(int paramInt)
  {
    ...
    synchronized (this)
    {
      ...
      localAttributeChangeNotification = new AttributeChangeNotification(this, ++this.notifSeqNum, System.currentTimeMillis(), "Memory pressure level change detected", "MemoryPressure", "int", Integer.valueOf(i), Integer.valueOf(paramInt));
    }
